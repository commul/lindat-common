...
git_user="commul-dev"
git_email="commul-dev@eurac.edu"
...
if [ -z "$TRAVIS_TAG" ]; then
  ...
  git push --force -q "https://$GH_TOKEN@github.com/commul/lindat-common.git" master:gh-pages > /dev/null 2>&1
...
git remote add origin "https://$GH_TOKEN@github.com/commul/lindat-common.git"
